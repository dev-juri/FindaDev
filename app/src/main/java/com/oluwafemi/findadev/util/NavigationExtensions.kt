...
fun BottomNavigationView.setUpWithNavController(navGraphIds: List<Int>, fragmentManager: FragmentManager, containerId: Int, intent: Intent
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        if (this.selectedItemId == graphId) {
            ...
            attachHostFragment(fragmentManager, navHostFragment, index == 0)
        } else {
...
private fun attachHostFragment(
    fragmentManager: FragmentManager,
